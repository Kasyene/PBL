...
namespace PBLGame.Misc.Anim
{
    ...
    public class AnimationPlayer
    {
        ...
        /// An assigned model
        /// </summary>
        private ModelAnimatedComponent model = null;
        ...
        /// </summary>
        [Browsable(false)]
        public ModelAnimatedComponent Model { get { return model; } }
        ...
        public AnimationPlayer(AnimationClip clip, ModelAnimatedComponent model)
        {
            this.clip = clip;
            this.model = model;
        ...
        private class BoneInfo
        {
            ...
            public void SetModel(ModelAnimatedComponent model)
            {
                // Find this bone
